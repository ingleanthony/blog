...
export default function Post( {src} ) {
    return (
        <div className='container'>
            ...
            <p className='post-body'>
                Simply owning someone's information is power in and of itself. Maybe today its innocently collected to give you a better experience online, but tomorrow its used against your own privacy. It's only a matter of getting the information in the wrong hands and your better experience online turns into a <a className='post-link' href='https://www.theverge.com/2012/8/6/3224597/mat-honan-hacked-apple-icloud-google-twitter'>compromised life.</a> Now, sorry to seem so negative, but it is important to be aware of what's going on. However, with that being said
            </p>
        </div>
    )
}
