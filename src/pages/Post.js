...
export default function Post( {src} ) {
    return (
        <div className='container'>
            ...
            <h2>Wrap-Up</h2>
            <p className='post-body'>
                Artificial intelligence is not something we should scared of. It is a technological advancement towards our future that will enable us to live better and brighter futures. It is technology that can make parts of ours lives easier and allow us to rid of some monotonous tasks. It will allow us to connect to things that we love and enhance our productivity. I hope that you learned something new from my post today and I hope you can have a better outlook on the technology that drives our future.
            </p>
            <br /><br />
        </div>
    )
